...
const PortfolioDetailPage = () => {
    ...
    const projectData = {
        ...
        task: {
            title: "Task",
            description:
                "Driving feature development and performance improvements for Gym Log, with a focus on exercise logging, routine customization, progress tracking, and seamless user interaction.",
        },
        serviceDetails: [
            {
                title: "Exercise Library Expansion",
                description:
                    "Added a broader selection of exercises with structured categorization and improved user navigation, enabling more personalized training programs.",
            },
            {
                title: "Enhanced Workout Logging",
                description:
                    "Streamlined the workout logging process for faster input and better tracking of sets, reps, and weights—boosting user efficiency in the gym.",
            },
            {
                title: "Progress Tracking & Visual Insights",
                description:
                    "Built visual progress charts and detailed workout summaries to help users monitor performance trends and stay motivated.",
            },
            {
                title: "Cloud Sync & Smart Reminders",
                description:
                    "Integrated cross-device sync and timely reminders, ensuring users stay consistent with their routines anytime, anywhere.",
            },
        ],
        galleryImages: [
            "/gym-log-app.png",
        ...
        cta: {
            tagline: "Build Better Fitness Experiences",
            projectPrompt: "Creating a health or fitness app?",
            link: "/contact",
            description:
                "Partner with us to create performance-focused fitness applications with powerful tracking, intuitive interfaces, and features that help users stay committed to their goals.",
        },
    };
                ...
                <div className="flex flex-col xl:flex-row xl:gap-24 sm:gap-16 xl:pt-64 sm:pt-40 justify-between w-full">
                    ...
                    <div>
                        ...
                        <div className='flex gap-4'>
                            <Link href="https://play.google.com/store/apps/details?id=gymworkout.gym.gymlog.gymtrainer" className="font-bold text-[15px] flex gap-2 items-center mt-4 hover:bg-[#F2F2F2] p-2 w-fit rounded-md leading-[16px] hover:text-[#141DEA] group transition-all duration-500 ease-in-out">
