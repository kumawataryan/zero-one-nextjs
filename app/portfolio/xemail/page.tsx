...
const projectData = {
  serviceHero: {
    servicesOffered: [
      { name: "AI-Powered App Development", link: "/" },
      { name: "Productivity Tools", link: "/" },
    ],
    date: "Completed",
    clientName: "Xemail",
    shortInfo:
      "Developed Xemail—an AI-powered email writing and reply assistant that helps users compose professional emails, letters, and message replies in seconds. Powered by GPT-4 and ChatGPT API, the app is built for speed, clarity, and productivity in everyday communication.",
  },
  task: {
    title: "Task",
    description:
      "Built a smart email writing tool powered by AI to assist users in generating high-quality emails, replies, and professional correspondence across personal and business contexts—faster and more efficiently.",
  },
  serviceDetails: [
    {
      title: "AI Email & Reply Generator",
      description:
        "Integrated GPT-4 via ChatGPT API to craft personalized, clear, and context-aware email drafts and replies within seconds.",
    },
    {
      title: "Multi-Use Case Writing Modes",
      description:
        "Designed templates for business emails, cover letters, informal messages, and even WhatsApp replies—making it versatile across communication needs.",
    },
    {
      title: "Instant Editing & Personalization",
      description:
        "Enabled tone adjustment, grammar correction, and customization to match writing style and purpose—ensuring every message feels authentic.",
    },
    {
      title: "Clean, Focused User Experience",
      description:
        "Delivered a clutter-free interface for fast content generation, ideal for professionals, students, and anyone seeking quick email productivity boosts.",
    },
  ],
  galleryImages: [
    "/xemail.png",
  ...
  cta: {
    tagline: "Write Smarter with AI-Powered Messaging",
    projectPrompt: "Building an AI productivity tool?",
    link: "/contact",
    description:
      "Work with us to create intelligent writing and communication tools powered by the latest AI technology—designed for speed, clarity, and professional results.",
  },
};
