            ...
            <div className="max-w-[1200px] w-full">
                ...
                <div className="flex flex-col xl:flex-row xl:gap-24 sm:gap-16 xl:pt-64 sm:pt-40 justify-between w-full">
                    ...
                    <div>
                        ...
                        <Link href="https://play.google.com/store/apps/details?id=lose.weight.together" className="font-bold text-[15px] flex gap-2 items-center mt-4 hover:bg-[#F2F2F2] p-2 w-fit rounded-md leading-[16px] hover:text-[#141DEA] group transition-all duration-500 ease-in-out">
