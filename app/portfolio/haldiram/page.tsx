...
const PortfolioDetailPage = () => {
  ...
  const projectData = {
    serviceHero: {
      servicesOffered: [
        { name: "Custom Packaging Design", link: "/" },
        { name: "3D Modeling & Mockups", link: "/" },
        { name: "Landing Page Development", link: "/" },
      ],
      date: "October 2023",
      clientName: "Haldiram's",
      shortInfo:
        "01 Agency partnered with Haldiram’s to design premium, minimalistic corporate gift packaging for their Diwali gifting initiative. The project involved creating unique packaging, 3D models and mockups for marketing, and a user-friendly landing page for bulk orders, helping Haldiram’s enhance their corporate gifting business.",
    },
    task: {
      title: "Task",
      description:
        "Our goal was to create a sleek, minimalistic corporate gift packaging for Haldiram’s Diwali campaign, ensuring the design maintained the brand’s aesthetic while offering a premium feel. We also developed 3D models and mockups for marketing, along with a dedicated landing page for facilitating corporate bulk orders.",
    },
    serviceDetails: [
      {
        title: "Custom Packaging Design",
        description:
          "Designed a premium, minimalistic corporate gift box for Haldiram’s Diwali gifting initiative. The packaging balanced modern elegance with Haldiram’s brand identity, ensuring a high-end gift appeal while retaining consistency with existing product designs.",
      },
      {
        title: "3D Modeling & Mockups",
        description:
          "Created detailed 3D models and mockups of the corporate gift boxes to help visualize the final design. These mockups allowed corporate clients to see the packaging before finalizing bulk orders, streamlining decision-making and ensuring client satisfaction.",
      },
      {
        title: "Landing Page Development",
        description:
          "Developed a dedicated, user-friendly landing page to showcase the corporate gift packs. Integrated an inquiry and ordering system, allowing corporate clients to seamlessly place bulk orders with personalized message cards for their employees and clients.",
      },
    ],
    galleryImages: [
      "/Portfolio/portfolio-haldiram.jpg",
    ],
    cta: {
      tagline: "Gift with Elegance this Festive Season",
      projectPrompt: "Looking for premium corporate gifting solutions?",
      link: "/contact",
      description:
        "Partner with 01 Agency to create a sophisticated, customizable gifting solution for your corporate clients. Whether it’s for Diwali or another special occasion, our packaging designs, 3D mockups, and online ordering system will ensure a seamless gifting experience.",
    },
  };
