...
const PortfolioDetailPage = () => {
  ...
  const projectData = {
    serviceHero: {
      servicesOffered: [
        { name: "3D Modeling & Rendering", link: "/" },
    ...
    task: {
      title: "Task",
      description:
        "01 Agency developed high-precision 3D models and mockups for MyProtein’s products, streamlining their design workflow, cutting photography costs, and ensuring consistent imagery across multiple e-commerce platforms.",
    },
    serviceDetails: [
      {
        title: "3D Model & Mockup Development",
        description:
          "Created highly detailed 3D models of MyProtein's products, including jars, bags, pouches, and bottles, ensuring realistic textures, lighting, and consistent branding across platforms.",
      },
      {
        title: "Cost-Effective Product Visualization",
        description:
          "Replaced traditional product photography with hyper-realistic 3D renders, saving over $10,000 per month and reducing banner design costs by 80%. Allowed easy modifications without reshoots.",
      },
      {
        title: "Automated Image Export System",
        description:
          "Developed a system to automate image exports for 10+ platforms, significantly reducing manual errors and processing time by 90%. Streamlined resizing and exporting to meet platform-specific requirements.",
      },
    ],
    galleryImages: [
      "/Portfolio/portfolio-my-protein.jpg",
    ],
    cta: {
      tagline: "Streamline Your Product Imagery",
      projectPrompt: "Looking for cost-effective and scalable product visualization solutions?",
      link: "/contact",
      description:
        "Partner with 01 Agency to replace expensive photography with high-quality 3D models and mockups, automate your design workflow, and ensure consistency across e-commerce platforms.",
    },
  };
