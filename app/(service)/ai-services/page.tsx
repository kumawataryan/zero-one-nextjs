...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        },
        {
            ...
            label: "Custom",
            content: [
                { label: "Consulting Hours", detail: "Custom" },
                { label: "Data Scientists", detail: "Custom" },
                { label: "Model Training", detail: "Custom" },
                { label: "Deployment", detail: "Custom" },
                { label: "Support", icon: <Check className="w-4 h-4" /> },
                { label: "Documentation", icon: <Check className="w-4 h-4" /> },
            ],
