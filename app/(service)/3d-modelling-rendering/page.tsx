...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        },
        {
            ...
            label: "Custom",
            content: [
                { label: "Renderings", detail: "custom number of renderings" },
                { label: "Revisions", detail: "custom number of revisions" },
                { label: "Delivery Time", detail: "custom delivery time" },
                { label: "Consultation", icon: <Check className="w-4 h-4" /> },
                { label: "High-Resolution Images", icon: <Check className="w-4 h-4" /> },
                { label: "Custom Texturing", icon: <Check className="w-4 h-4" /> },
                { label: "Lighting Setup", icon: <Check className="w-4 h-4" /> },
                { label: "Animation", icon: <Check className="w-4 h-4" /> },
            ],
