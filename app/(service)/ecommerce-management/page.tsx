...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        },
        {
            ...
            label: "Custom",
            content: [
                { label: "Product Listings", detail: "Tailored as per needs" },
                { label: "Inventory Management", detail: "Customized tracking" },
                { label: "Order Management", detail: "Customized workflows" },
                { label: "SEO Optimization", icon: <Check className="w-4 h-4" /> },
                { label: "Dedicated Support", icon: <Check className="w-4 h-4" /> },
                { label: "Comprehensive Reports", icon: <Check className="w-4 h-4" /> }
            ],
