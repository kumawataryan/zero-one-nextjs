...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        },
        {
            ...
            label: "Custom",
            content: [
                { label: "Game Scope", detail: "Fully customized" },
                { label: "Platforms", detail: "Any" },
                { label: "Graphics", detail: "2D or 3D, customized" },
                { label: "Dedicated QA Team", icon: <Check className="w-4 h-4" /> },
                { label: "Custom Music & Sound", icon: <Check className="w-4 h-4" /> },
                { label: "Post-Launch Support", icon: <Check className="w-4 h-4" /> }
            ],
