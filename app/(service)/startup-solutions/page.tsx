...
const ServicePage = () => {
    ...
    const portfolioData = [
        ...
        {
            name: "EdTech Application",
            link: "/portfolio/edtech",
            image: "/portfolio/startup-3.jpg",
            tags: [
                { tagLink: '/portfolio/startup-solutions', tagName: 'Startup Solutions' },
                { tagLink: '/portfolio/completed', tagName: 'Completed' }
            ]
    ...
    const pricingData = [
        ...
        {
            value: "custom",
            label: "Custom Startup Solutions",
            content: [
