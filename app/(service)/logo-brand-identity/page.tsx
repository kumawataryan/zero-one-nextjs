...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        },
        {
            ...
            content: [
                { label: "Tailored Branding Strategy", detail: "Fully customized approach" },
                { label: "Logo & Brand Identity Design", icon: <Check className="w-4 h-4" /> },
                { label: "Consultation & Support", icon: <Check className="w-4 h-4" /> },
                { label: "Ongoing Brand Development", icon: <Check className="w-4 h-4" /> },
