...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        {
            value: "custom",
            label: "Custom Press Release Solutions",
            content: [
                { label: "Tailored Press Release Strategy", detail: "Based on specific needs" },
