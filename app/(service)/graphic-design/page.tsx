...
const ServicePage = () => {
    ...
    const pricingData = [
        ...
        },
        {
            ...
            label: "Custom",
            content: [
                { label: "Design Scope", detail: "Fully tailored solutions" },
                { label: "Deliverables", detail: "Custom formats" },
                { label: "Branding & Marketing Assets", icon: <Check className="w-4 h-4" /> },
                { label: "Custom Graphics & Illustrations", icon: <Check className="w-4 h-4" /> },
                { label: "Unlimited Revisions", detail: "Client-focused" },
                { label: "Brand Strategy Consultation", icon: <Check className="w-4 h-4" /> },
            ],
