export const SERVICES = [
  ...
  },
  {
    ...
    tags: [
      { link: '/tag15', name: 'Blender' },
      { link: '/tag16', name: '3ds Max' },
    ],
  },
  {
    ...
    tools: [
      ...
      { link: '/tag21', name: 'Artificial Intelligence' },
      { link: '/tag22', name: 'Business Solutions' },
    ],
  },
  {
    name: 'AI Services',
    ...
    tags: [
      { link: '/tag23', name: 'AI Development' },
      { link: '/tag24', name: 'Machine Learning' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag25', name: 'Blockchain' },
      { link: '/tag26', name: 'Cryptocurrency' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag27', name: 'Blockchain' },
      { link: '/tag28', name: 'Development' },
    ],
  },
  {
    name: 'Data Scraping',
    ...
    tags: [
      { link: '/tag29', name: 'Data Extraction' },
      { link: '/tag30', name: 'Web Scraping' },
    ],
  },
  {
  ...
  },
  {
    ...
    tags: [
      { link: '/tag5', name: 'Shopify' },
      { link: '/tag6', name: 'WooCommerce' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag31', name: 'Ecommerce' },
      { link: '/tag32', name: 'Management' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag11', name: 'Unity' },
      { link: '/tag12', name: 'Unreal Engine' },
    ],
  },
  {
    name: 'Graphic Design',
    ...
    tags: [
      { link: '/tag7', name: 'Adobe Photoshop' },
      { link: '/tag8', name: 'Illustrator' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag33', name: 'Leads' },
      { link: '/tag34', name: 'Sales' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag19', name: 'Brand Strategy' },
      { link: '/tag20', name: 'Logo Design' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag17', name: 'Technical Support' },
      { link: '/tag18', name: 'System Maintenance' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag35', name: 'Marketing' },
      { link: '/tag36', name: 'Strategy' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag37', name: 'Packaging' },
      { link: '/tag38', name: 'Design' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag39', name: 'Public Relations' },
      { link: '/tag40', name: 'Brand Image' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag41', name: 'Shopify' },
      { link: '/tag42', name: 'Ecommerce' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag43', name: 'Social Media' },
      { link: '/tag44', name: 'Marketing' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag45', name: 'Software' },
      { link: '/tag46', name: 'Development' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag47', name: 'Staff' },
      { link: '/tag48', name: 'Augmentation' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag13', name: 'MVP Development' },
      { link: '/tag14', name: 'Business Strategy' },
    ],
  },
  {
    ...
    tags: [
      { link: '/tag49', name: 'Consultation' },
      { link: '/tag50', name: 'Technology' },
    ],
  },
  {
    name: 'UI/UX Design',
    ...
    tags: [
      { link: '/tag3', name: 'Figma' },
      { link: '/tag4', name: 'Sketch' },
    ],
  },
  {
...
export const BLOGS = [
  {
    ...
    image: '/Blogs/blog-image-1.png',  // Ensure these paths are correct
    title: 'In-Depth Analysis of Fortis Healthcare: Transforming Patient Care Through Innovative Strategies',
    link: 'news/strong-brand-identity'
  },
  {
    date: 'October 18, 2024',
    image: '/Blogs/blog-image-2.png',
    title: 'Exploring Ashok Leyland’s Journey: How They Revolutionized the Commercial Vehicle Industry',
    link: 'news/digital-marketing-importance'
  },
  {
    date: 'October 15, 2024',
    image: '/Blogs/blog-image-3.png',
    title: 'Myntra’s Success Story: Strategies That Shaped India’s Leading Fashion E-Commerce Platform',
    link: 'news/seo-best-practices-2024'
  },
  {
    date: 'October 10, 2024',
    image: '/Blogs/blog-image-4.png',
    title: 'Hyundai’s Growth Strategy: Innovative Approaches That Led to Market Leadership in India',
    link: 'news/engaging-content-tips'
  },
  {
    date: 'October 15, 2024',
    image: '/Blogs/blog-image-3.png',
