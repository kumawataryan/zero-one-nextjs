    ...
    return (
        <div className='bg-[#161616] md:py-48 sm:py-24 w-full px-6'>
            ...
            <Tabs defaultValue="form" className="flex xl:flex-row sm:flex-col md:gap-8 sm:gap-4 items-start">
                <TabsList className='flex md:flex-col sm:flex-col sm:items-start bg-transparent md:gap-3 sm:gap-1 bg-[#161616] w-full sm:py-2 md:py-0 rounded-none xl:w-1/5'>
                ...
                <TabsContent value="form" className='top-0 w-full'>
                    <form action="" className='flex flex-col gap-4'>
                        <div className='flex md:flex-row sm:flex-col gap-4 w-full'>
                            <Input className='border-[0.5px] border-white bg-[#F5F5F5]/10 md:h-16 sm:h-12 md:px-6 sm:px-4' placeholder='Name' required />
                            <Input className='border-[0.5px] border-white bg-[#F5F5F5]/10 md:h-16 sm:h-12 md:px-6 sm:px-4' placeholder='Email*' required />
                            <Input className='border-[0.5px] border-white bg-[#F5F5F5]/10 md:h-16 sm:h-12 md:px-6 sm:px-4' placeholder='Phone' />
                        </div>
                        <Textarea className='border-[0.5px] border-white bg-[#F5F5F5]/10 h-16 md:p-6 sm:p-4' placeholder='Describe your project' required />
