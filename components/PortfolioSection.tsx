        ...
        <section className='flex flex-col justify-left items-left mb-6'>
            ...
            <div className='flex gap-1 mt-4 flex-wrap'>
                {tagsList.map((tag, index) => (
                    <div
                        key={index}
                        className={`uppercase text-nowrap leadin-[10px] text-[12px] px-4 p-3 rounded-full cursor-pointer ${selectedTag === tag.tagName ? 'bg-black text-white' : 'bg-transparent border border-black text-black'}`}
            ...
            <div className="columns-1 sm:columns-1 md:columns-2 lg:columns-2 xl:columns-3 2xl:columns-4 gap-8 space-y-16 xl:mt-10 sm:mt-4">
